...
<head>
    ...
    <title>SCO-ENICAR Ajouter classe</title>
    <!-- Bootstrap core CSS -->
...
<main role="main">
        <div class="jumbotron">
            <div class="container">
              <h1 class="display-4">Ajouter une classe</h1>
              <p>Remplir le formulaire ci-dessous afin d'ajouter une classe!</p>
            </div>
          </div>


<div class="container">
 <form id="myform" method="GET" action="ajoutgrp.php">
     <!--
     ...
     <label for="nom_g">Nom du Classe:</label><br>
     <input type="text" id="nom_g" name="nom_g" class="form-control" required autofocus>
    </div>
