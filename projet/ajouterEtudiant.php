...
<div class="container">
 <form id="myform" method="GET" action="ajouter.php">
    ...
    <div class="form-group">
     ...
     <input type="text" id="classe" name="classe" placeholder="Example: INFO1-A" class="form-control" required pattern="INFO[1-3]{1}-[A-E]{1}"
     ...
     <option value="" disabled="" selected="">Choisir une classe</option>
           ...
           $query = "SELECT DISTINCT nom_g FROM groupe ORDER BY nom_g ASC";
          ...
          {
           echo '<option value="'.$row["nom_g"].'">'.$row["nom_g"].'</option>'; 
          } 
?>
</select>
</div>
     ...
     <!--Bouton Ajouter-->
     <button  type="submit" class="btn btn-primary" style="margin-left: 120px;">Ajouter</button>
